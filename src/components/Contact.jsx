const Contact = () => {
    const contactInfo = [
        {
            href: 'mailto:mahideep536@gmail.com',
            label: 'Email',
            value: 'mahideep536@gmail.com',
            icon: (
                ...
                <div className="contact-content">
                    <div className="contact-info">
                        <p className="contact-description">
                            I'm currently looking for Software Engineer / Software Engineer Intern opportunities.
                            Feel free to reach out if you'd like to discuss potential collaborations or just say hello!
                        </p>
                        <div className="contact-cards">
                            {contactInfo.map((contact, index) => (
                                <a href={contact.href} className="contact-card" key={index}>
